...
public class VideoView : NativeControlHost
{
    ...
    private readonly BehaviorSubject<Maybe<IMediaPlayer>> mediaPlayers = new(Maybe<IMediaPlayer>.None);
    ...
    public IMediaPlayer MediaPlayer
    {
        ...
        set => mediaPlayers.OnNext(Maybe.From(value));
    }
